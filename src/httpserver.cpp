...
HTTPRequest::~HTTPRequest()
{
    ...
    // performing this check due to fuzz http_request case (otherwise would fail with fatal error)
    // m_uri_parsed won't be initialised - reply was set to true (check HTTPRequest::HTTPRequest)
    if (m_uri_parsed != nullptr) evhttp_uri_free(m_uri_parsed);
}
